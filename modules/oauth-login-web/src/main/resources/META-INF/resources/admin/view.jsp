...
<liferay-ui:search-container
	emptyResultsMessage="there-are-no-oauth-connections"
>

	<liferay-ui:search-container-results
		results="<%= oAuthConnectionLocalService.getOAuthConnections(searchContainer.getStart(), searchContainer.getEnd()) %>"
	/>

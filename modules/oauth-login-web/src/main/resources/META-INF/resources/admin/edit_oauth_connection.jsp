...
<%@page import="com.liferay.oauthlogin.model.impl.OAuthConnectionImpl"%>
<%@ include file="/admin/init.jsp" %>

<%
String redirect = ParamUtil.getString(request, "redirect");

OAuthConnectionImpl oAuthConnection = (OAuthConnectionImpl)request.getAttribute(WebKeys.OAUTH_CONNECTION);

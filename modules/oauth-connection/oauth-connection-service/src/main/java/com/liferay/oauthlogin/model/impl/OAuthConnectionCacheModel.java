 ...
 */
@ProviderType
public class OAuthConnectionCacheModel
	implements CacheModel<OAuthConnection>, Externalizable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof OAuthConnectionCacheModel)) {
			return false;
		}

		OAuthConnectionCacheModel oAuthConnectionCacheModel =
			(OAuthConnectionCacheModel)obj;

		if (oAuthConnectionId == oAuthConnectionCacheModel.oAuthConnectionId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, oAuthConnectionId);
	}
	...
	public OAuthConnection toEntityModel() {
		...
		if (description == null) {
			oAuthConnectionImpl.setDescription("");
		}
		else {
		...
		if (authorizeURL == null) {
			oAuthConnectionImpl.setAuthorizeURL("");
		}
		else {
		...
		if (accessTokenURL == null) {
			oAuthConnectionImpl.setAccessTokenURL("");
		}
		else {
		...
		if (requestTokenURL == null) {
			oAuthConnectionImpl.setRequestTokenURL("");
		}
		else {
		...
		if (redirectURL == null) {
			oAuthConnectionImpl.setRedirectURL("");
		}
		else {
		...
		if (socialAccountIdURL == null) {
			oAuthConnectionImpl.setSocialAccountIdURL("");
		}
		else {
		...
		if (socialAccountIdField == null) {
			oAuthConnectionImpl.setSocialAccountIdField("");
		}
		else {

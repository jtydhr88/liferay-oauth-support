...
public class OAuthConnectionSoap implements Serializable {
	...
	public static OAuthConnectionSoap toSoapModel(OAuthConnection model) {
		...
		soapModel.setAccessTokenExtractorType(
			model.getAccessTokenExtractorType());
	...
	public static OAuthConnectionSoap[] toSoapModels(OAuthConnection[] models) {
		OAuthConnectionSoap[] soapModels =
			new OAuthConnectionSoap[models.length];
	...
	public static OAuthConnectionSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels =
				new OAuthConnectionSoap[models.length][models[0].length];
		}
		else {
	...
	public static OAuthConnectionSoap[] toSoapModels(
		...
		List<OAuthConnectionSoap> soapModels =
			new ArrayList<OAuthConnectionSoap>(models.size());
